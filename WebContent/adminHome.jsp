...
<div class="w3-container">
  <div class="w3-bar w3-black">
     ...
     <button class="w3-bar-item w3-button tablink" onclick="openCity(event,'Tokyo');window.open('http://192.168.22.63:5000/', '_self')">果園狀況顯示</button>
  ...
  <div class="tbl-content">
    <table cellpadding="0" cellspacing="0" border="0">
      <tbody>
          ...
          <td><input type="button" name="start" value="開始駕車"  onclick="window.open('http://192.168.22.63:5000/activate', '_blank')"></td>
      </tbody>
    </table>
  </div>
</section>
